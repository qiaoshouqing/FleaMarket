...
public class SearchActivity extends Activity implements OnClickListener{
	...
	private String purl = "http://glimpse.sinaapp.com/fsearch_android.php";
	...
	private void initView() {
		...
		moredata.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(isNet.IsConnect())
				{
					key = content.getText().toString();
					url = purl + "?key=" + key  +"&start=" + start;
		...
		searchResult.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				GoodsEntity pe = (GoodsEntity) searchResult.getItemAtPosition(position);
		...
		searchResult.addFooterView(moreView);
		searchResult.setAdapter(goodsAdapter);
