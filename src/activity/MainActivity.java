...
public class MainActivity extends Activity implements OnClickListener{
	...
	private String purl = "http://glimpse.sinaapp.com/fgoods_all_android.php";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		PushManager.startWork(getApplicationContext(),
                ...
                "scM8mzcGhiq7NiwXM0PcT36q");
		
		if(isNet.IsConnect())
		{
			UpdateManager manager = new UpdateManager(ctx, true);
			// 检查软件更新
			manager.checkUpdate();
		}
